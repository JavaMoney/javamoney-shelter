...
public class HistoricRateProviderTest {
    ...
    public void shouldReturnErrorWhenDoesNotFindTheExchangeRate2() {
    ...
    @Test
    public void shouldFindFromHistoricalUsingPeriod2() {
        LocalDate localDate = YearMonth.of(2011, Month.JANUARY).atDay(9);
		ConversionQuery conversionQuery = HistoricConversionQueryBuilder
    ...
    @Test(expectedExceptions = MonetaryException.class)
    public void shouldReturnErrorWhenFindFromHistoricalUsingPeriod2() {
